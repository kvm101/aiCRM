...
public class AIChatServiceTest {
    ...
    void generateReply_ShouldConvertHistoryAndCallOrchestrator() {
        ...
        verify(orchestrator, times(1)).generateWithFallback(anyString(), eq("How are you?"), anyList(), eq("openai"));
    }
    ...
    void generateReply_WithNullHistory_ShouldHandleGracefully() {
        ...
        verify(orchestrator, times(1)).generateWithFallback(anyString(), eq("Tell me a joke"), anyList(), eq("google"));
    }
}
