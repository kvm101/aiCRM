...
public class AnalyticsService {
    ...
    public Map<String, Object> getGoals(Long projectId, Long userId) {
        ...
        String targetPeriod = user.getTargetPeriod() != null ? user.getTargetPeriod().toUpperCase() : "MONTH";
    ...
    public Map<String, Object> updateGoals(Long projectId, Long userId, BigDecimal targetRevenue, String currency, String targetPeriod) {
        Optional<User> userOpt = userRepository.findById(userId);
