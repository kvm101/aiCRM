...
public class DealService {
    ...
    public DealService(DealRepository dealRepository, ClientRepository clientRepository, UserRepository userRepository, DealEventRepository dealEventRepository, ProjectRepository projectRepository) {
    ...
    public List<DealEventDto> getDealEvents(Long projectId, Long dealId) {
        Deal deal = getDeal(projectId, dealId); // Verify access
