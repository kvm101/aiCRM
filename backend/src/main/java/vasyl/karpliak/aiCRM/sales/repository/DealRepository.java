...
public interface DealRepository extends JpaRepository<Deal, Long> {
  ...
  List<Deal> findByProjectIdAndStatus(
      Long projectId, vasyl.karpliak.aiCRM.sales.enums.DealStatus status);
  ...
  BigDecimal sumBudgetByProjectIdAndStatus(
      @Param("projectId") Long projectId,
      @Param("status") vasyl.karpliak.aiCRM.sales.enums.DealStatus status);
}
