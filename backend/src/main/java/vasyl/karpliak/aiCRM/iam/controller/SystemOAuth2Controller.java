...
public class SystemOAuth2Controller {
  ...
  public RedirectView login() {
    String authUrl =
        "https://accounts.google.com/o/oauth2/v2/auth?"
            ...
            + "&scope="
            + URLEncoder.encode(
                "https://mail.google.com/ openid email profile", StandardCharsets.UTF_8)
            + "&access_type=offline"
  ...
  public RedirectView callback(
      @RequestParam("code") String code, HttpServletResponse httpResponse) {
          ...
          if (email != null) {
            ...
            ResponseCookie cookie =
                ResponseCookie.from("user_id", Long.toString(user.getId()))
                    .path("/")
                    .httpOnly(
                        false) // So frontend can read it if needed, or keep httpOnly and add a /me
                    // endpoint
