...
public class OAuth2Controller {
  ...
  @Value(
      "${spring.ai.google.redirect.uri:${google.redirect.uri:http://localhost:8080/iam/oauth2/google/callback}}")
  ...
  public RedirectView login(@RequestParam("userId") Long userId) {
    String authUrl =
        "https://accounts.google.com/o/oauth2/v2/auth?"
            ...
            + "&response_type=code"
            + "&scope="
            + URLEncoder.encode("https://mail.google.com/ openid email", StandardCharsets.UTF_8)
            + "&access_type=offline"
