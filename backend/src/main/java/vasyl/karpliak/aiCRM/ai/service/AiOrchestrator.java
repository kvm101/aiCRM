...
public class AiOrchestrator {
  ...
  public String generateWithFallback(
    ...
    String provider =
        (modelProvider == null || modelProvider.isBlank()) ? "auto" : modelProvider.toLowerCase();
  ...
  private String callWithChatClient(
      ChatModel model, String systemPrompt, String userMessage, List<Message> history) {
  ...
  private String extractReason(Exception e) {
    ...
    if (msg.contains("400") || msg.contains("tool_use_failed"))
      return "400 Bad Request / Tool Format Error";
  ...
  private String formatProviderError(String providerName, Exception e) {
    ...
    return "⚠️ **"
        ...
        + "Переключіться на Auto або іншу модель. Помилка: "
        + extractReason(e);
  }
}
