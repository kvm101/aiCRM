...
public class CommunicationsAITools {
  ...
  public String sendEmail(String to, String subject, String text) {
    ...
    String from =
        org.springframework.util.StringUtils.hasText(systemMailSender)
            ? systemMailSender
            : "noreply@example.com";
    mailService.sendToMail(mailData, from);
    return "Email успішно заплановано до відправки на " + to;
  }

  @Tool(
      description =
          "Отримати список відкритих чатів (сесій) у Facebook Messenger для поточного користувача.")
  ...
  @Tool(
      description =
          "Прочитати історію повідомлень конкретного чату (за sessionId), щоб зрозуміти контекст розмови з клієнтом.")
  ...
  @Tool(
      description =
          "Отримати всі вхідні повідомлення від клієнтів за вказаний період (since — ISO дата-час початку, наприклад '2026-05-01T00:00:00'). Використовується для сумаризації активності за день, тиждень або місяць.")
