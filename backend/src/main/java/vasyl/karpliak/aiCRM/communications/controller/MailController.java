...
public class MailController {
  ...
  @PostMapping("/mail")
  public ResponseEntity<MailData> sendMail(
      @RequestBody MailData mailData, @RequestHeader(name = "X-User-Id") String user_id) {
  ...
  public ResponseEntity<List<EmailMessageDto>> getFolderEmails(
    ...
    return ResponseEntity.ok(
        mailService.getFolderEmails(Long.parseLong(userId), folder.toUpperCase(), userRole));
  }
