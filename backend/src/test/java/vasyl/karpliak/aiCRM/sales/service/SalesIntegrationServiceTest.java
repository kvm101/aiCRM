...
public class SalesIntegrationServiceTest {
  ...
  @InjectMocks private SalesIntegrationService salesIntegrationService;
  ...
  void processIncomingMessage_WithNewClient_ShouldCreateClientAndDeal() {
    ...
    ClientDTO mockClientDTO =
        new ClientDTO(100L, "Facebook User", null, "fb_123", null, ClientStatus.NEW, null, null);
    ...
    verify(dealService, times(1))
        .addNoteToDeal(eq(1L), eq(200L), eq("Вхідне повідомлення: Hello CRM"));
