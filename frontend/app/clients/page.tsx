    ...
    <div className="space-y-6 max-w-6xl mx-auto h-[calc(100vh-4rem)] flex flex-col">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shrink-0">
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400 mt-1">База ваших контактів та клієнтів.</p>
        </div>
      ...
      <div className="flex-1 bg-white dark:bg-zinc-950 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden min-h-0">
